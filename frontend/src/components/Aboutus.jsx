          ...
          <Row>
            <Col md={4}>
              <div className="value-card">
                ...
                <h3>Pet Welfare</h3>
                <p>We prioritize the health and happiness of all animals in everything we do.</p>
              </div>
            </Col>
            <Col md={4}>
              <div className="value-card">
                ...
                <h3>Quality</h3>
                <p>We only offer products that meet our strict quality and safety standards.</p>
              </div>
            </Col>
            <Col md={4}>
              <div className="value-card">
                ...
                <h3>Community</h3>
                <p>We support pet owners through education and exceptional service.</p>
              </div>
            </Col>
          </Row>
        </section>
